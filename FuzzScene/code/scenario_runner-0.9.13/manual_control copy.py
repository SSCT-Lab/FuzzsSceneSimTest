    ...
    def _parse_image(weak_self, image, player):
        ...
        if self.recording:
            ...
            if number_record > 15 and number_record <= 140:
                ...
                image.save_to_disk('/home/vangogh/code/fileSystem/downloadDir/simulation_result/%08d' % frameid)
                ...
                file_path = '/home/vangogh/code/fileSystem/downloadDir/simulation_result/label_test.csv'
